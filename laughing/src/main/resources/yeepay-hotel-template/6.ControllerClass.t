{"entityControllerClassName":"${entityName}Controller","entityControllerPackageName":"${basePackageName}.etrading.controller"}
...
public class ${entityControllerClassName}  extends BaseFunctionalController{
    @Resource

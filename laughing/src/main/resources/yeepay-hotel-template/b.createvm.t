{"":""}
/${webappPath}/WEB-INF/pages/${moduleName}/${entityReferName}.create.vm
...
<body>
	<div id="content">
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
		        	<form id="${entityReferName}" class="form-horizontal" method="post" action="create" enctype="multipart/form-data" >
						<div class="widget-box">
							<div class="widget-title"><h5 class="font16">新增</h5></div>
							<div class="widget-content nopadding">
#foreach($attr in $!attrs)
								<div class="control-group">
									<label class="control-label">$attr.cnName</label>
									<div class="controls1"><input type="text" id="$attr.aliasInJava" name="$attr.aliasInJava" style="width:200px;" maxlength="20"></div>
								</div>
#end

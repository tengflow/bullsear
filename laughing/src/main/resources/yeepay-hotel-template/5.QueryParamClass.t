{"entityQueryName":"${entityReferName}Query","entityQueryClassName":"${entityName}Query","entityQueryPackageName":"${basePackageName}.etrading.controller.query"}
/${javaPath}/#packagetopath("${entityQueryPackageName}.${entityQueryClassName}").java
package ${entityQueryPackageName};

import org.apache.commons.lang.StringUtils;

import com.yeepay.hotel.utils.PageQuery;
